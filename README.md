...
3. **Gateway Backend API:** FastAPI server managing concurrent threads, reading edge telemetry via wildcards, managing a real-time table cache, and exposing RESTful endpoints.
4. **Persistence Layer:** MariaDB database for caching and configuration.
